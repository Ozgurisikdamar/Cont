...
STOP_SECTIONS = {
    ...
    "sources", "citations", "footnotes", "works cited", "selected works", "works", "publications",
    "discography", "filmography", "gallery",
}
_TERMINAL = tuple('.!?:;"”)]')
_ABBREVIATIONS = (
    "e.g.", "i.e.", "etc.", "vs.", "cf.", "ca.", "c.", "approx.", "Dr.", "Mr.", "Mrs.", "Ms.", "Prof.",
    "St.", "Jr.", "Sr.", "No.", "Nos.", "Fig.", "Vol.", "U.S.", "U.K.", "U.N.", "Inc.", "Ltd.", "Co.",
    "Gen.", "Col.", "Lt.", "Capt.", "Sgt.", "Gov.", "Rev.", "Mt.", "al.", "op.", "ed.", "eds.",
)
_ABBR_TOKEN = "⁣"  # invisible separator used to protect abbreviation dots
