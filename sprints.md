...
## S6 — Application ✅ (tuning pending S5)
- `TopicModel` (calibrated general head, hierarchical subtopic heads, OOD gate),
...
- Data integrity (`tests/test_leakage.py`), real-artifact acceptance and edge cases
  ...
  marker `network`). → `docs/TEST_REPORT.md`.
...
- Pending results: README, MODEL_REPORT, MODEL_CARD, EXPERIMENTS, ERROR_ANALYSIS,
